        ...
        <form onSubmit={formOnSubmit} className="space-y-2 mt-5 ">
          ...
          <div className="py-3 ">
            <button
              type="submit"
              className="flex 
              2  justify-center rounded-md bg-[#FC4BA4] px-3 py-1.5 text-sm font-semibold leading-6 text-white focus:outline-0 shadow-sm hover:bg-[#F00F80] transition-colors duration-500 ease-in-out"
            >
              Add Toys
            </button>
          </div>
